...
def unif_m1_unif_m2(m1,m2,mmin_bh=3.,mmax_bh=23.,mmin=1.,mmax=3.): # uniform distribution in source frame masses, subject to m1 >= m2 convention
...
def unif_m1_unif_m2_qpair(m1,m2,mmin_bh=3.,mmax_bh=23.,mmin=1.,mmax=3.,beta=2.): # uniform distribution in source frame masses, subject to m1 >= m2 convention
...
def unif_m1_peakcut_m2(m1,m2,mu=1.34,sigma=0.02,mmin_bh=3.,mmax_bh=23.,mmin=1.,mmax=3.): # uniform distribution in source frame masses, subject to m1 >= m2 convention
...
def unif_m1_peakcut_m2_qpair(m1,m2,mu=1.34,sigma=0.02,mmin_bh=3.,mmax_bh=23.,mmin=1.,mmax=3.,beta=2.): # uniform distribution in source frame masses, subject to m1 >= m2 convention
...
def unif_m1_bimodcut_m2(m1,m2,mu1=1.34,sigma1=0.07,mu2=1.80,sigma2=0.21,alpha=0.65,mmin_bh=3.,mmax_bh=23.,mmin=0.9,mmax=2.12): # uniform distribution in source frame masses, subject to m1 >= m2 convention
...
def unif_m1_bimodcut_m2_qpair(m1,m2,mu1=1.34,sigma1=0.07,mu2=1.80,sigma2=0.21,alpha=0.65,mmin=0.9,mmax=2.12,mmin_bh=3.,mmax_bh=23.,beta=2.): # uniform distribution in source frame masses, subject to m1 >= m2 convention
...
pop_params = {'unif_mass': 'mmin,mmax', 'peak_mass': 'mu,sigma', 'bimod_mass': 'mu1,sigma1,mu2,sigma2,alpha', 'peakcut_mass': 'mu,sigma,mmin,mmax', 'bimodcut_mass': 'mu1,sigma1,mu2,sigma2,alpha,mmin,mmax', 'unif_m1m2': 'mmin,mmax', 'peak_m1m2': 'mu,sigma', 'bimod_m1m2': 'mu1,sigma1,mu2,sigma2,alpha', 'peakcut_m1m2': 'mu,sigma,mmin,mmax', 'bimodcut_m1m2': 'mu1,sigma1,mu2,sigma2,alpha,mmin,mmax', 'peakcut_m1_unif_m2': 'mu,sigma,mmin,mmax', 'bimodcut_m1_unif_m2': 'mu1,sigma1,mu2,sigma2,alpha,mmin,mmax', 'unif_m1m2_qpair': 'mmin,mmax,beta', 'peakcut_m1m2_qpair': 'mu,sigma,mmin,mmax,beta', 'bimodcut_m1m2_qpair': 'mu1,sigma1,mu2,sigma2,alpha,mmin,mmax,beta', 'o3a_powerpeak_m1m2_qpair': 'lpeak,alpha,beta,mmin,mmax,delta,mu,sigma', 'o3a_powerbreak_m1m2_qpair': 'alpha1,alpha2,beta,mmin,mmax,delta,b', 'o3a_powerpeak_m1_unif_m2': 'm1,m2,mu,sigma,mmin,mmax', 'unif_m1_unif_m2': 'm1,m2,mmin,mmax', 'unif_m1_unif_m2_qpair': 'm1,m2,mmin,mmax,beta', 'unif_m1_peakcut_m2': 'm1,m2,mu,sigma,mmin,mmax', 'unif_m1_peakcut_m2_qpair': 'm1,m2,mu,sigma,mmin,mmax,beta', 'unif_m1_bimodcut_m2': 'm1,m2,mu1,sigma1,mu2,sigma2,alpha,mmin,mmax', 'unif_m1_bimodcut_m2_qpair': 'm1,m2,mu1,sigma1,mu2,sigma2,alpha,mmin,mmax,beta', 'bimodcut_m1m2_snrcut': 'm1,m2,dl,mu1,sigma1,mu2,sigma2,alpha,mmin,mmax'}
