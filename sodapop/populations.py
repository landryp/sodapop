...
def bimod_m1_unif_m2(m1,m2,mu1=1.34,sigma1=0.02,mu2=1.47,sigma2=0.15,alpha=0.68,mmin=1.,mmax=3.,norms=False): # double gaussian mass distribution with high- and low-mass cutoffs
